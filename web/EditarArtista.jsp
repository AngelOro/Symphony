<%-- 
    ...
    Created on : 23-jun-2019, 14:00:01
    Author     : Angelica
--%>
                ...
                <section id="main-content">
                    <section id="wrapper">
                        <div class="row">
                            ...
                            <center><h2 class="text-center">Modificar Artista</h2></center><br><br>
                            <div class="row row-table col-lg-11" style="margin-top:0px;">
                                <%
                                    Artista a = (Artista) request.getAttribute("artista");
                                %>
                                <form method="post" class="form-group" id="editarEmpresa" action="ServletArtista">
                                    ...
                                    <div class="form-inline">
                                        <label class="control-label col-sm-5" for="nombreArt">Nombre Artista:</label>
                                        <div class="col-sm-6"> 
                                            <% out.println("<input class='form-control' type='text' name='nombreArt' id='nombreArt' value='"
                                                        + a.getNombreArtista() + "'/><br>"); %>  
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <label class="control-label col-sm-5" for="empresaDifusora">Empresa Difusora:</label>
                                        <div class="col-sm-6"> 
                                            <select class="form-control" id="tipoOperacion" name="empresaDifusora"  required>
                                                    ...
                                                    for (Empresa e : listaEmpresa) {
                                                        if (e.getIdEmpresa() == a.getIdEmpresa()) {
                                                            out.println("<option value='" + e.getIdEmpresa()
                                                                    + "' selected>" + e.getNombreEmpresa() + "</option>");
                                                        } else {
                                                            out.println("<option value='" + e.getIdEmpresa()
                                                                    + "' >" + e.getNombreEmpresa() + "</option>");
                                                        }
                                                    }
                                                %>
                                            </select>
                                    ...
                                    <div class="form-inline">
                                        <label class="control-label col-sm-5" for="emailArt">Correo:</label>
                                        <div class="col-sm-6"> 
                                            <% out.println("<input class='form-control' type='text' name='emailArt' id='emailArt' value='"
                                                        + a.getCorreo() + "'/><br>"); %>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                    ...
                                    <div class="form-inline" readonly>
                                        <label for="estado" >Estado: </label>
                                        <div class="col-sm-6"> 
                                            <% if (a.getEstado().equalsIgnoreCase("Activo")) { %>
                                            <input type="radio" name="estado" value="Activo" checked="checked"> Activo
                                            <% } else { %>
                                            <input type="radio" name="estado" value="Activo"> Activo
                                            <% } %>
                                            <% if (a.getEstado().equalsIgnoreCase("Inactivo")) { %>
                                            <input type="radio" name="estado" value="Inactivo" checked="checked"> Inactivo <br/>
                                            <% } else { %>
