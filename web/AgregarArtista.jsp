<%-- 
    ...
    Created on : 22-jun-2019, 18:36:29
    Author     : Angelica
--%>
                ...
                <section id="main-content">
                    <section id="wrapper">
                        <div class="row">
                            ...
                            <center><h2 class="text-center">Crear Artista</h2></center><br><br>
                            <div class="row row-table col-lg-11" style="margin-top:0px;">

                                <form method="post" class="form-group" id="agregarArtista" action="ServletArtista">
                                    <input type="hidden" name="operacion" id="operacion" value="crear" >  
                                    <label for="idArtista" style="display: none;">Id Artista </label>
                                    <input type="hidden" name="idArtista" id="idArtista" value="0" >
                                    <div class="form-inline">
                                        <label class="control-label col-sm-5" for="nameArt">Nombre Artista:</label>
                                        <div class="col-sm-6"> 
                                            <input type="text" class="form-control" id="nameArt" name="nameArt" required>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                            ...
                                            <select class="form-control" id="tipoOperacion" name="empresaDifusora"  required>
                                                ...
                                                <%
                                                    ...
                                                    while (iter.hasNext()) {
                                                        ...
                                                        out.println("<option value='" + emp.getIdEmpresa() + "' >" + emp.getNombreEmpresa() + "</option>");
                                                    }
                                                %>
                                            </select>
                                    ...
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-6"> 
                                            <input type="email" class="form-control" id="emailArt" name="emailArt" required>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                    ...
                                    <div class="form-inline" readonly>
                                        ...
                                        <div class="col-sm-6"> 
                                            <input type="radio" name="estado" value="Activo" checked readonly> Activo
                                            <input type="radio" name="estado" value="Inactivo" style="display: none;"> <br/>
                                        </div>
                                    </div>
